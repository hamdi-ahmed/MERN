...
class EditHouse extends Component {
    ...
    componentDidMount() {
        axios.get("http://localhost:5000/house/" + this.props.match.params.id)
            .then(res => {
                this.setState({
                    city: res.data.city,
                    ...
                    numberOfBedroom: res.data.numberOfBedroom,
                    numberOfBathroom: res.data.numberOfBathroom
                })
            })
            .catch((err) => {
                console.log(err);
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/house/update/' + this.props.match.params.id, house)
        ...
        return (
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Edit Now" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
